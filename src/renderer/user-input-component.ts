...
export const userInputComponent = Vue.extend({
    ...
    computed: {
        ...
        userInputReadonly(): boolean {
            return this.previewMode.active;
        },
    },
    methods: {
        keyPress(event: KeyboardEvent) {
            ...
            if (event.key === "ArrowRight") {
                vueEventDispatcher.$emit(VueEventChannels.previewRequested, this.userInput);
            }
        ...
        resetUserInput(): void {
            ...
            this.previewMode.displayedIcon = null;
        },
    ...
    mounted() {
        ...
        vueEventDispatcher.$on(VueEventChannels.activatePreviewMode, (displayedText: string, displayedIcon?: Icon) => {
            this.previewMode.active = true;
            this.userInput = displayedText;
            this.previewMode.displayedIcon = displayedIcon;
        });
    ...
    template: `
        <div class="user-input">
            ...
            <div v-if="config.appearanceOptions.showSearchIcon" v-html="getIcon()" class="user-input__search-icon-container"></div>
            <input 
                :disabled="userInputDisabled"
                :readonly="userInputReadonly"
                ref="userInput"
                id="user-input"
